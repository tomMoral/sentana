...
%Insérer les courbes de training ici.
\begin{figure}[h]
\begin{subfigure}{0.48\columnwidth}
\includegraphics[width=\textwidth]{fig/reg_curves.png}
\caption{Courbe validation error pour paramètre régularisation (log10)}
\end{subfigure}
\begin{subfigure}{0.48\columnwidth}
\includegraphics[width=\textwidth]{fig/lr_curves.png}
\caption{Courbe validation error pour learning rate (log10)}
\end{subfigure}
\begin{subfigure}{0.48\columnwidth}
\includegraphics[width=\textwidth]{fig/mb_curves.png}
